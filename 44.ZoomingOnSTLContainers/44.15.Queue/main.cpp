...
int main(){
    ...
    numbers1.push(10); // 10 is at the front of queue. First element which will be served (poped)
    numbers1.push(20);
    numbers1.push(30); // 30 is at the back of queue. Last element.
    ...
    numbers1.front() = 500; // NEW_FOR_ME direct access through front() and back()
    numbers1.back() = 600;
    ...
    numbers1.pop(); // NEW_FOR_ME pop() removes the front element which is at the beginning of the queue
                    // and has highest priority for "serving"
    ...
    clear_queue(numbers1); // NEW_FOR_ME clearing queue by means of poping ("serving") elements in a loop
    ...
    books.push(Book(1921,"The Art of War")); // This will be the front 1st element - head of queue
    ...
    std::queue<int,std::list<int>> numbers3; // NEW_FOR_ME declare queue which uses list as underlying container
    std::queue<int,std::deque<int>> numbers4; // NEW_FOR_ME declare queue which uses deque as underlying container
