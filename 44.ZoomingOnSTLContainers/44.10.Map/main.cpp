...
int main(){
    ...
    for(const auto&[key,value] : books){ // NEW_FOR_ME structured binding
    ...
    //Insert key 2 : won't insert because std::map doesn't allow duplicate keys.
   ...
   print_map(numbers);
    ...
    auto result_emplace = numbers.emplace(std::make_pair(7,18)); // NEW_FOR_ME map::emaplace with std::make_pair()
    ...
    std::map<int,int> numbers_01 {{1,11},{0,12},{4,13},{2,14},{3,15}};//Default
    std::map<int,int,std::less<int>> numbers_02 {{1,11},{0,12},{4,13},{2,14},{3,15}};//Built in functor
    std::map<int,int,std::greater<int>> numbers_03 {{1,11},{0,12},{4,13},{2,14},{3,15}};
    std::map<int,int,IntComparator> numbers_04 {{1,11},{0,12},{4,13},{2,14},{3,15}}; // Custom functor
    std::map<int,int,bool(*)(int,int)> numbers_05(compare_ints); // Custom funtion pointer
    numbers_05.insert({{1,11},{0,12},{4,13},{2,14},{3,15}});
    std::map<int,int,std::function<bool(int,int)>> numbers_06([](int left, int right){ //Lambda function
        return left > right ;
    });
    numbers_06.insert({{1,11},{0,12},{4,13},{2,14},{3,15}});

    std::cout << "numbers_01 : [ "; for (const auto& [key,value] : numbers_01) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
    std::cout << "numbers_02 : [ "; for (const auto& [key,value] : numbers_02) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
    std::cout << "numbers_03 : [ "; for (const auto& [key,value] : numbers_03) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
    std::cout << "numbers_04 : [ "; for (const auto& [key,value] : numbers_04) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
    std::cout << "numbers_05 : [ "; for (const auto& [key,value] : numbers_05) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
    std::cout << "numbers_06 : [ "; for (const auto& [key,value] : numbers_06) { std::cout << " (" << key << "," << value << ")"; } std::cout << "]\n";
