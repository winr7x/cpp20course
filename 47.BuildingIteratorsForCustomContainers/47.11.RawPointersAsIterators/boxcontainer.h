...
public:
	...
	public :
		// NEW_FOR_ME you can avoid the hard work we did to set the iterator
		// but use raw pointer as iterators
		T* begin() { return m_items; } // NEW_FOR_ME all you need to do is just return the pointer with your begin() and end() method
