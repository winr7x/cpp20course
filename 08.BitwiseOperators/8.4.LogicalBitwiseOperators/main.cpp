...
int main(){
    ...
    std::cout << std::setw(COLUMN_WIDTH) << "value1 & value2 : "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(value1 & value2) << std::endl;  // 0011 & 0101 == 0001
    std::cout << std::endl;
    ...
    std::cout << std::setw(COLUMN_WIDTH) << "value1 | value2 : "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(value1 | value2) << std::endl;  // 0011 | 0101 == 0111
    std::cout << std::endl;
    ...
    std::cout << std::setw(COLUMN_WIDTH) << "~value1 : "
		<< std::setw(COLUMN_WIDTH) <<  std::bitset<8>(~value1) << std::endl;         // ~0011 == (1)1100
		
    std::cout << std::setw(COLUMN_WIDTH) << "~value2 : "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(~value2) << std::endl;          // ~0101 == (1)1010
		
    std::cout << std::setw(COLUMN_WIDTH) << "~01011001 : "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(~0b01011001) << std::endl;//Using bin literal // ~0b01011001 == 10100110
    ...
    std::cout << std::setw(COLUMN_WIDTH) << "value1 ^ value2 : "                       // 0011 ^ 0101 == 0110
